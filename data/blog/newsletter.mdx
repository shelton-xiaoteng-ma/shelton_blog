---
title: 'Mailerlite for Newsletter'
date: 2024-12-06 16:26:59
tags: ['newsletter', 'mailerlite']
draft: false
summary: ''
images: []
authors: ['default']
...
1. [Sign up](https://accounts.mailerlite.com/) and create group
2. Integrations, generate new api token
3. Create NewsletterForm component

    ```ts
    // Claude create NewsletterForm for me
    'use client'
